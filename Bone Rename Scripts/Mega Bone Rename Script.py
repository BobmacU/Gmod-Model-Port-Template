...
# ===============================
bone_replacements_ci = {k.lower(): v for k, v in bone_replacements.items()}
...
# ===============================
# 2) Rename bones (case-insensitive match, exact output)
# ===============================
for arm in bpy.data.armatures:
    for bone in arm.bones:
        new_name = bone_replacements_ci.get(bone.name.lower())
        if new_name:
            bone.name = new_name
